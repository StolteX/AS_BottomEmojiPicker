...
public class main implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("main"), "com.stolte.bottomactionmenu.main");
	}
...
public static com.stolte.bottomactionmenu.b4xcollections _b4xcollections = null;
  public Object[] GetGlobals() {
		return new Object[] {"ActionBarHomeClicked",main._actionbarhomeclicked,"Activity",main.mostCurrent._activity,"B4XCollections",Debug.moduleToString(com.stolte.bottomactionmenu.b4xcollections.class),"B4XPages",Debug.moduleToString(com.stolte.bottomactionmenu.b4xpages.class),"Starter",Debug.moduleToString(com.stolte.bottomactionmenu.starter.class)};
}
}