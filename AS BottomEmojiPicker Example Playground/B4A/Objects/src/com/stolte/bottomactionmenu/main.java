...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "com.stolte.bottomactionmenu", "com.stolte.bottomactionmenu.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.stolte.bottomactionmenu", "com.stolte.bottomactionmenu.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.stolte.bottomactionmenu.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ (null);
...
com.stolte.bottomactionmenu.b4xpagesmanager _pm = null;
RDebugUtils.currentLine=131072;
 //BA.debugLineNum = 131072;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=131073;
 //BA.debugLineNum = 131073;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new com.stolte.bottomactionmenu.b4xpagesmanager();
...
if (true) return mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (null,_keycode);
...
mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._activity_pause /*String*/ (null);
...
mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (null,_permission,_result);
...
mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._activity_resume /*String*/ (null);
...
mostCurrent._b4xpages._delegate /*com.stolte.bottomactionmenu.b4xpagesdelegator*/ ._create_menu /*String*/ (null,_menu);
