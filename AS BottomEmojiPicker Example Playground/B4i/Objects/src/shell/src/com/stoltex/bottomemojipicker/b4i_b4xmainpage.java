...
public static RemoteObject _bottomemojipicker = RemoteObject.declareNull("b4i_as_bottomemojipicker");
public static b4i_main _main = null;
public static b4i_b4xpages _b4xpages = null;
public static b4i_b4xcollections _b4xcollections = null;
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"BottomEmojiPicker",_ref.getField(false, "_bottomemojipicker"),"Root",_ref.getField(false, "_root"),"xui",_ref.getField(false, "_xui")};
}
}