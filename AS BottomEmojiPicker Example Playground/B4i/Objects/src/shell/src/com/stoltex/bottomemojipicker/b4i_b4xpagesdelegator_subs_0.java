...
try {
		Debug.PushSubsStack("Activity_Pause (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "bi"),__ref,52);
...
try {
		Debug.PushSubsStack("Activity_Resume (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "bi"),__ref,48);
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "bi"),__ref,4);
...
try {
		Debug.PushSubsStack("MainForm_Resize (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "bi"),__ref,44);
