...
try {
		Debug.PushSubsStack("Initialize (b4xcomparatorsort) ","b4xcomparatorsort",9,__ref.getField(false, "bi"),__ref,4);
...
try {
		Debug.PushSubsStack("Partition (b4xcomparatorsort) ","b4xcomparatorsort",9,__ref.getField(false, "bi"),__ref,30);
...
try {
		Debug.PushSubsStack("QuickSort (b4xcomparatorsort) ","b4xcomparatorsort",9,__ref.getField(false, "bi"),__ref,21);
...
try {
		Debug.PushSubsStack("Sort (b4xcomparatorsort) ","b4xcomparatorsort",9,__ref.getField(false, "bi"),__ref,12);
...
try {
		Debug.PushSubsStack("Swap (b4xcomparatorsort) ","b4xcomparatorsort",9,__ref.getField(false, "bi"),__ref,44);
