...
public class b4i_asdraggablebottomcard_subs_0 {


public static RemoteObject  _addpangesture(RemoteObject __ref,RemoteObject _minimumtouch,RemoteObject _maximumtouch) throws Exception{
try {
		Debug.PushSubsStack("AddPanGesture (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,490);
if (RapidSub.canDelegate("addpangesture")) { return __ref.runUserSub(false, "asdraggablebottomcard","addpangesture", __ref, _minimumtouch, _maximumtouch);}
Debug.locals.put("MinimumTouch", _minimumtouch);
Debug.locals.put("MaximumTouch", _maximumtouch);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mview" /*RemoteObject*/ ).setObject ((__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ )).getObject());
 BA.debugLineNum = 492;BA.debugLine="nome.RunMethod(\"grPan:::\",Array(xpnl_CardHeader,M";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_nome" /*RemoteObject*/ ).runVoidMethod ("RunMethod::",(Object)(BA.ObjectToString("grPan:::")),(Object)(RemoteObject.createNew("B4IArray").runMethod(false, "initObjectsWithData:", (Object)new RemoteObject[] {((__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ )).getObject()),(_minimumtouch),(_maximumtouch)})));
 BA.debugLineNum = 493;BA.debugLine="If m_BodyDrag Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_m_bodydrag" /*RemoteObject*/ ).getBoolean()) { 
 BA.debugLineNum = 494;BA.debugLine="mView2 = xpnl_CardBody";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mview2" /*RemoteObject*/ ).setObject ((__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ )).getObject());
 BA.debugLineNum = 495;BA.debugLine="nome.RunMethod(\"grPan:::\",Array(xpnl_CardBody,Min";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_nome" /*RemoteObject*/ ).runVoidMethod ("RunMethod::",(Object)(BA.ObjectToString("grPan:::")),(Object)(RemoteObject.createNew("B4IArray").runMethod(false, "initObjectsWithData:", (Object)new RemoteObject[] {((__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ )).getObject()),(_minimumtouch),(_maximumtouch)})));
 };
...
try {
		Debug.PushSubsStack("Base_Resize (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,137);
if (RapidSub.canDelegate("base_resize")) { return __ref.runUserSub(false, "asdraggablebottomcard","base_resize", __ref, _width, _height);}
RemoteObject _tmp_left = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_g_orientation" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.runClassMethod (b4i_asdraggablebottomcard.class, "_orientation_middle" /*RemoteObject*/ )))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_g_orientation" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.runClassMethod (b4i_asdraggablebottomcard.class, "_orientation_right" /*RemoteObject*/ )))) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(_tmp_left),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_height,__ref.getField(true,"_g_first_height" /*RemoteObject*/ )}, "+",1, 0))),(Object)(__ref.getField(true,"_g_width" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_g_first_height" /*RemoteObject*/ )));
 BA.debugLineNum = 148;BA.debugLine="xpnl_CardHeader.SetLayoutAnimated(0,0,0,g_width,g";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(true,"_g_width" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_g_header_height" /*RemoteObject*/ )));
 BA.debugLineNum = 150;BA.debugLine="xpnl_CardBody.SetLayoutAnimated(0,0,g_header_heig";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(true,"_g_header_height" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_g_width" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_g_first_height" /*RemoteObject*/ )));
...
b4i_asdraggablebottomcard._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_asdraggablebottomcard._meventname);
 //BA.debugLineNum = 59;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_asdraggablebottomcard._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_asdraggablebottomcard._mcallback);
 //BA.debugLineNum = 61;BA.debugLine="Private xui As XUI 'ignore";
b4i_asdraggablebottomcard._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_asdraggablebottomcard._xui);
 //BA.debugLineNum = 62;BA.debugLine="Private mDarkPanel As B4XView";
b4i_asdraggablebottomcard._mdarkpanel = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mdarkpanel",b4i_asdraggablebottomcard._mdarkpanel);
 //BA.debugLineNum = 64;BA.debugLine="Private downy As Float";
b4i_asdraggablebottomcard._downy = RemoteObject.createImmutable(0.0f);__ref.setField("_downy",b4i_asdraggablebottomcard._downy);
 //BA.debugLineNum = 65;BA.debugLine="Private old_top As Float";
b4i_asdraggablebottomcard._old_top = RemoteObject.createImmutable(0.0f);__ref.setField("_old_top",b4i_asdraggablebottomcard._old_top);
 //BA.debugLineNum = 67;BA.debugLine="Private g_first_height,g_second_height,g_width,g_";
b4i_asdraggablebottomcard._g_first_height = RemoteObject.createImmutable(0.0f);__ref.setField("_g_first_height",b4i_asdraggablebottomcard._g_first_height);
b4i_asdraggablebottomcard._g_second_height = RemoteObject.createImmutable(0.0f);__ref.setField("_g_second_height",b4i_asdraggablebottomcard._g_second_height);
b4i_asdraggablebottomcard._g_width = RemoteObject.createImmutable(0.0f);__ref.setField("_g_width",b4i_asdraggablebottomcard._g_width);
b4i_asdraggablebottomcard._g_header_height = RemoteObject.createImmutable(0.0f);__ref.setField("_g_header_height",b4i_asdraggablebottomcard._g_header_height);
 //BA.debugLineNum = 68;BA.debugLine="Private g_orientation As Int";
b4i_asdraggablebottomcard._g_orientation = RemoteObject.createImmutable(0);__ref.setField("_g_orientation",b4i_asdraggablebottomcard._g_orientation);
 //BA.debugLineNum = 70;BA.debugLine="Public g_show_duration As Int = 250";
b4i_asdraggablebottomcard._g_show_duration = BA.numberCast(int.class, 250);__ref.setField("_g_show_duration",b4i_asdraggablebottomcard._g_show_duration);
 //BA.debugLineNum = 71;BA.debugLine="Public g_hide_duration As Int = 700";
b4i_asdraggablebottomcard._g_hide_duration = BA.numberCast(int.class, 700);__ref.setField("_g_hide_duration",b4i_asdraggablebottomcard._g_hide_duration);
 //BA.debugLineNum = 72;BA.debugLine="Private g_darkpanel_alpha As Int = 165";
b4i_asdraggablebottomcard._g_darkpanel_alpha = BA.numberCast(int.class, 165);__ref.setField("_g_darkpanel_alpha",b4i_asdraggablebottomcard._g_darkpanel_alpha);
 //BA.debugLineNum = 73;BA.debugLine="Private g_IsDraggable As Boolean = True";
b4i_asdraggablebottomcard._g_isdraggable = b4i_main.__c.runMethod(true,"True");__ref.setField("_g_isdraggable",b4i_asdraggablebottomcard._g_isdraggable);
 //BA.debugLineNum = 74;BA.debugLine="Private mDarkPanelClickable As Boolean = True";
b4i_asdraggablebottomcard._mdarkpanelclickable = b4i_main.__c.runMethod(true,"True");__ref.setField("_mdarkpanelclickable",b4i_asdraggablebottomcard._mdarkpanelclickable);
 //BA.debugLineNum = 75;BA.debugLine="Private mUserCanClose As Boolean = True";
b4i_asdraggablebottomcard._musercanclose = b4i_main.__c.runMethod(true,"True");__ref.setField("_musercanclose",b4i_asdraggablebottomcard._musercanclose);
 //BA.debugLineNum = 78;BA.debugLine="Private m_BodyDrag As Boolean = False";
b4i_asdraggablebottomcard._m_bodydrag = b4i_main.__c.runMethod(true,"False");__ref.setField("_m_bodydrag",b4i_asdraggablebottomcard._m_bodydrag);
 //BA.debugLineNum = 79;BA.debugLine="Private expand_state As Int = 0";
b4i_asdraggablebottomcard._expand_state = BA.numberCast(int.class, 0);__ref.setField("_expand_state",b4i_asdraggablebottomcard._expand_state);
 //BA.debugLineNum = 81;BA.debugLine="Private disable_touch As Boolean = False";
b4i_asdraggablebottomcard._disable_touch = b4i_main.__c.runMethod(true,"False");__ref.setField("_disable_touch",b4i_asdraggablebottomcard._disable_touch);
 //BA.debugLineNum = 83;BA.debugLine="Private last_swipe2top As Boolean = False";
b4i_asdraggablebottomcard._last_swipe2top = b4i_main.__c.runMethod(true,"False");__ref.setField("_last_swipe2top",b4i_asdraggablebottomcard._last_swipe2top);
 //BA.debugLineNum = 84;BA.debugLine="Private inClosingProcess As Boolean = False";
b4i_asdraggablebottomcard._inclosingprocess = b4i_main.__c.runMethod(true,"False");__ref.setField("_inclosingprocess",b4i_asdraggablebottomcard._inclosingprocess);
 //BA.debugLineNum = 89;BA.debugLine="Private xpnl_CardBase As B4XView";
b4i_asdraggablebottomcard._xpnl_cardbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_xpnl_cardbase",b4i_asdraggablebottomcard._xpnl_cardbase);
 //BA.debugLineNum = 90;BA.debugLine="Private xpnl_CardHeader As B4XView";
b4i_asdraggablebottomcard._xpnl_cardheader = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_xpnl_cardheader",b4i_asdraggablebottomcard._xpnl_cardheader);
 //BA.debugLineNum = 91;BA.debugLine="Private xpnl_CardBody As B4XView";
b4i_asdraggablebottomcard._xpnl_cardbody = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_xpnl_cardbody",b4i_asdraggablebottomcard._xpnl_cardbody);
 //BA.debugLineNum = 96;BA.debugLine="Private nome As NativeObject=Me";
b4i_asdraggablebottomcard._nome = RemoteObject.createNew ("B4INativeObject");
b4i_asdraggablebottomcard._nome = BA.rdebugUtils.runMethod(false, "ConvertToWrapper::", RemoteObject.createNew("B4INativeObject"), __ref);__ref.setField("_nome",b4i_asdraggablebottomcard._nome);
 //BA.debugLineNum = 97;BA.debugLine="Private mView As View'ignore";
b4i_asdraggablebottomcard._mview = RemoteObject.createNew ("B4IViewWrapper");__ref.setField("_mview",b4i_asdraggablebottomcard._mview);
 //BA.debugLineNum = 98;BA.debugLine="Private mView2 As View'ignore";
b4i_asdraggablebottomcard._mview2 = RemoteObject.createNew ("B4IViewWrapper");__ref.setField("_mview2",b4i_asdraggablebottomcard._mview2);
...
try {
		Debug.PushSubsStack("Create (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,108);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_ini_views:" /*RemoteObject*/ ,(Object)(_parent));
 BA.debugLineNum = 127;BA.debugLine="AddPanGesture(1,2)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_addpangesture::" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 2)));
 BA.debugLineNum = 134;BA.debugLine="Base_Resize(Parent.Width,Parent.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_base_resize::" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _parent.runMethod(true,"Width"))),(Object)(BA.numberCast(double.class, _parent.runMethod(true,"Height"))));
...
try {
		Debug.PushSubsStack("ExpandFull (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,382);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_showintern::" /*void*/ ,(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(b4i_main.__c.runMethod(true,"True")));
...
try {
		Debug.PushSubsStack("ExpandHalf (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,387);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_showintern::" /*void*/ ,(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(b4i_main.__c.runMethod(true,"False")));
...
try {
		Debug.PushSubsStack("getBodyDrag (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,459);
...
try {
		Debug.PushSubsStack("getBodyPanel (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,401);
...
try {
		Debug.PushSubsStack("getCardBase (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,341);
...
try {
		Debug.PushSubsStack("getDarkPanel (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,337);
...
try {
		Debug.PushSubsStack("getDarkPanelAlpha (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,441);
...
try {
		Debug.PushSubsStack("getDarkPanelClickable (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,445);
...
try {
		Debug.PushSubsStack("getFirstHeight (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,345);
...
try {
		Debug.PushSubsStack("getHeaderHeight (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,369);
...
try {
		Debug.PushSubsStack("getHeaderPanel (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,392);
...
try {
		Debug.PushSubsStack("getIsDraggable (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,437);
...
try {
		Debug.PushSubsStack("getIsOpen (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,421);
...
try {
		Debug.PushSubsStack("getIsOpenFull (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,429);
...
try {
		Debug.PushSubsStack("getIsOpenHalf (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,425);
...
try {
		Debug.PushSubsStack("getSecondHeight (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,357);
...
try {
		Debug.PushSubsStack("getUserCanClose (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,329);
...
try {
		Debug.PushSubsStack("HandleTouch (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,282);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_g_isdraggable" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False")) || RemoteObject.solveBoolean("=",__ref.getField(true,"_disable_touch" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"True"))) { 
if (true) return b4i_main.__c.runMethod(true,"False");};
 BA.debugLineNum = 284;BA.debugLine="If Action = xpnl_CardBase.TOUCH_ACTION_DOWN Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, __ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_DOWN")))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_visiblebodyheightchanged" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_old_top" /*RemoteObject*/ ,__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top"));
 }else 
{ BA.debugLineNum = 294;BA.debugLine="Else if Action = xpnl_CardBase.TOUCH_ACTION_MOVE";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, __ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_MOVE")))) { 
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_last_swipe2top" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"True"));
 }else {
 BA.debugLineNum = 298;BA.debugLine="last_swipe2top = False";
Debug.JustUpdateDeviceLine();
__ref.setField ("_last_swipe2top" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"False"));
 };
 BA.debugLineNum = 301;BA.debugLine="If mUserCanClose = True Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_musercanclose" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"True"))) { 
 BA.debugLineNum = 302;BA.debugLine="xpnl_CardBase.Top = Max(mDarkPanel.Height - g_s";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"setTop:",BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Max::",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_second_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "--",2, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top"),_y,__ref.getField(true,"_downy" /*RemoteObject*/ )}, "+-",2, 0)))));
 }else {
 BA.debugLineNum = 304;BA.debugLine="xpnl_CardBase.Top = Min(mDarkPanel.Height - g_f";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"setTop:",BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Min::",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_first_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "--",2, 0)),(Object)(b4i_main.__c.runMethod(true,"Max::",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_second_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "--",2, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top"),_y,__ref.getField(true,"_downy" /*RemoteObject*/ )}, "+-",2, 0)))))));
 };
 BA.debugLineNum = 307;BA.debugLine="If xpnl_CardBase.Top < (mDarkPanel.Height - g_fi";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top"),(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_first_height" /*RemoteObject*/ )}, "-",1, 0)))) { 
 BA.debugLineNum = 308;BA.debugLine="expand_state = 2";
Debug.JustUpdateDeviceLine();
__ref.setField ("_expand_state" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 309;BA.debugLine="xpnl_CardBody.Height = g_second_height";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ ).runMethod(true,"setHeight:",__ref.getField(true,"_g_second_height" /*RemoteObject*/ ));
 BA.debugLineNum = 310;BA.debugLine="xpnl_CardBase.Height = g_second_height + g_head";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"setHeight:",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_g_second_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "+",1, 0)));
 }else {
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, __ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_UP")))) { 
 BA.debugLineNum = 317;BA.debugLine="If expand_state = 1 And old_top < xpnl_CardBase.";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_expand_state" /*RemoteObject*/ ),BA.numberCast(double.class, 1)) && RemoteObject.solveBoolean("<",__ref.getField(true,"_old_top" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top"))) && RemoteObject.solveBoolean("=",__ref.getField(true,"_last_swipe2top" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False")) && RemoteObject.solveBoolean("=",__ref.getField(true,"_musercanclose" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"True"))) { 
 BA.debugLineNum = 318;BA.debugLine="Hide(False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_hide:" /*void*/ ,(Object)(b4i_main.__c.runMethod(true,"False")));
 }else 
{ BA.debugLineNum = 319;BA.debugLine="Else if expand_state = 2 And old_top < xpnl_Card";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_expand_state" /*RemoteObject*/ ),BA.numberCast(double.class, 2)) && RemoteObject.solveBoolean("<",__ref.getField(true,"_old_top" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Top")))) { 
...
try {
		Debug.PushSubsStack("Hide (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,231);
...
public ResumableSub_Hide(b4i_asdraggablebottomcard parent,RemoteObject __ref,RemoteObject _ignore_event) {
this.parent = parent;
this.__ref = __ref;
...
//if
this.state = 6;
if (__ref.getField(true,"_inclosingprocess" /*RemoteObject*/ ).getBoolean()) { 
this.state = 3;
;}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_inclosingprocess" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"True"));
...
//if
this.state = 10;
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists:::",(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Close"))),(Object)(BA.numberCast(int.class, 0))).getBoolean()) { 
this.state = 9;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub:::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Close"))));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(__ref.getField(true,"_g_hide_duration" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Left")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_first_height" /*RemoteObject*/ )}, "+",1, 0))),(Object)(__ref.getField(true,"_g_width" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Height")));
 BA.debugLineNum = 241;BA.debugLine="mDarkPanel.SetVisibleAnimated(g_hide_duration,Fal";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runVoidMethod ("SetVisibleAnimated::",(Object)(__ref.getField(true,"_g_hide_duration" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"False")));
...
//if
this.state = 20;
if (RemoteObject.solveBoolean("=",_ignore_event,b4i_main.__c.runMethod(true,"False"))) { 
this.state = 13;
}else {
this.state = 19;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "asdraggablebottomcard", "hide"),__ref.getField(true,"_g_hide_duration" /*RemoteObject*/ ));
this.state = 21;
return;
case 21:
//C
...
//if
this.state = 17;
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists:::",(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Closed"))),(Object)(BA.numberCast(int.class, 0))).getBoolean()) { 
this.state = 16;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub:::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Closed"))));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"setHeight:",__ref.getField(true,"_g_first_height" /*RemoteObject*/ ));
 BA.debugLineNum = 251;BA.debugLine="Sleep(0)";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "asdraggablebottomcard", "hide"),BA.numberCast(int.class, 0));
this.state = 23;
return;
case 23:
//C
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_inclosingprocess" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"False"));
...
try {
		Debug.PushSubsStack("ini_views (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,176);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_xpnl_cardbase" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("xpnl_CardBase"))));
 BA.debugLineNum = 178;BA.debugLine="xpnl_CardHeader = xui.CreatePanel(\"xpnl_header\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_xpnl_cardheader" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("xpnl_header"))));
 BA.debugLineNum = 179;BA.debugLine="xpnl_CardBody = xui.CreatePanel(\"\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_xpnl_cardbody" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable(""))));
 BA.debugLineNum = 180;BA.debugLine="mDarkPanel = xui.CreatePanel(\"mDarkPanel\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mdarkpanel" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("mDarkPanel"))));
 BA.debugLineNum = 181;BA.debugLine="Parent.AddView(mDarkPanel,0,0,0,0)";
Debug.JustUpdateDeviceLine();
_parent.runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 182;BA.debugLine="Parent.AddView(xpnl_CardBase,0,0,0,0)";
Debug.JustUpdateDeviceLine();
_parent.runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 183;BA.debugLine="xpnl_CardBase.AddView(xpnl_CardHeader,0,0,0,0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 184;BA.debugLine="xpnl_CardBase.AddView(xpnl_CardBody,0,0,0,0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"setVisible:",b4i_main.__c.runMethod(true,"False"));
...
try {
		Debug.PushSubsStack("Initialize (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,102);
...
try {
		Debug.PushSubsStack("mDarkPanel_Click (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,481);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_mdarkpanelclickable" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 483;BA.debugLine="mDarkPanel.Enabled = False";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"setEnabled:",b4i_main.__c.runMethod(true,"False"));
...
try {
		Debug.PushSubsStack("Orientation_LEFT (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,409);
...
try {
		Debug.PushSubsStack("Orientation_MIDDLE (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,413);
...
try {
		Debug.PushSubsStack("Orientation_RIGHT (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,417);
...
try {
		Debug.PushSubsStack("setBodyDrag (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,463);
...
try {
		Debug.PushSubsStack("setBodyPanel (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,405);
...
try {
		Debug.PushSubsStack("SetCircleClip (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,157);
...
try {
		Debug.PushSubsStack("setCornerRadius_Header (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,374);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ ).runMethod(true,"setHeight:",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_g_header_height" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*",0, 0)));
 BA.debugLineNum = 378;BA.debugLine="xpnl_CardHeader.SetColorAndBorder(xpnl_CardHeader";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder::::",(Object)(__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ ).runMethod(true,"Color")),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_radius));
 BA.debugLineNum = 379;BA.debugLine="SetCircleClip(xpnl_CardHeader,radius)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_setcircleclip::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xpnl_cardheader" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, _radius)));
...
try {
		Debug.PushSubsStack("setDarkPanelAlpha (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,453);
...
try {
		Debug.PushSubsStack("setDarkPanelClickable (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,449);
...
try {
		Debug.PushSubsStack("setFirstHeight (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,350);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_expandhalf" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("setHeaderPanel (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,396);
...
try {
		Debug.PushSubsStack("setIsDraggable (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,433);
...
try {
		Debug.PushSubsStack("setSecondHeight (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,362);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_expandfull" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("setUserCanClose (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,333);
...
try {
		Debug.PushSubsStack("Show (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,190);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_showintern::" /*void*/ ,(Object)(_ignore_event),(Object)(b4i_main.__c.runMethod(true,"False")));
...
try {
		Debug.PushSubsStack("ShowIntern (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,194);
...
public ResumableSub_ShowIntern(b4i_asdraggablebottomcard parent,RemoteObject __ref,RemoteObject _ignore_event,RemoteObject _fromtouch) {
this.parent = parent;
this.__ref = __ref;
this._ignore_event = _ignore_event;
...
//if
this.state = 4;
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists:::",(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Open"))),(Object)(BA.numberCast(int.class, 0))).getBoolean()) { 
this.state = 3;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub:::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Open"))));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"setEnabled:",b4i_main.__c.runMethod(true,"True"));
...
//if
this.state = 8;
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Visible"),b4i_main.__c.runMethod(true,"False"))) { 
this.state = 7;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runVoidMethod ("SetVisibleAnimated::",(Object)(__ref.getField(true,"_g_show_duration" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_disable_touch" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"True"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(__ref.getField(true,"_g_show_duration" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"Left")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(true,"_g_first_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "--",2, 0))),(Object)(__ref.getField(true,"_g_width" /*RemoteObject*/ )),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_g_second_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "+",1, 0))));
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "asdraggablebottomcard", "showintern"),__ref.getField(true,"_g_show_duration" /*RemoteObject*/ ));
this.state = 31;
return;
case 31:
//C
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"setHeight:",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_g_first_height" /*RemoteObject*/ ),__ref.getField(true,"_g_header_height" /*RemoteObject*/ )}, "+",1, 0)));
 BA.debugLineNum = 210;BA.debugLine="xpnl_CardBody.Height = g_first_height";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ ).runMethod(true,"setHeight:",__ref.getField(true,"_g_first_height" /*RemoteObject*/ ));
...
//if
this.state = 19;
if (RemoteObject.solveBoolean("=",_fromtouch,b4i_main.__c.runMethod(true,"False"))) { 
this.state = 16;
;}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_disable_touch" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"False"));
...
//if
this.state = 27;
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists:::",(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Opened"))),(Object)(BA.numberCast(int.class, 0))).getBoolean()) { 
this.state = 26;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub:::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Opened"))));
 if (true) break;
...
public static RemoteObject  _uigesture_pan(RemoteObject __ref,RemoteObject _state,RemoteObject _x,RemoteObject _y,RemoteObject _obj) throws Exception{
try {
		Debug.PushSubsStack("uigesture_pan (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,263);
if (RapidSub.canDelegate("uigesture_pan")) { return __ref.runUserSub(false, "asdraggablebottomcard","uigesture_pan", __ref, _state, _x, _y, _obj);}
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_handletouch::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_DOWN")),(Object)(_y));
 break; }
case 1: {
 BA.debugLineNum = 268;BA.debugLine="HandleTouch(xpnl_CardBase.TOUCH_ACTION_MOVE,y)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_handletouch::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_MOVE")),(Object)(_y));
 break; }
case 2: {
 BA.debugLineNum = 270;BA.debugLine="HandleTouch(xpnl_CardBase.TOUCH_ACTION_UP,y)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_asdraggablebottomcard.class, "_handletouch::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xpnl_cardbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_UP")),(Object)(_y));
 break; }
}
;
...
try {
		Debug.PushSubsStack("VisibleBodyHeightChanged (asdraggablebottomcard) ","asdraggablebottomcard",3,__ref.getField(false, "bi"),__ref,467);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists:::",(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_VisibleBodyHeightChanged"))),(Object)(BA.numberCast(int.class, 1))).getBoolean()) { 
 BA.debugLineNum = 469;BA.debugLine="CallSub2(mCallBack,mEventName & \"_VisibleBodyHei";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub2::::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_VisibleBodyHeightChanged"))),(Object)((__ref.getField(false,"_xpnl_cardbody" /*RemoteObject*/ ).runMethod(true,"Height"))));
 };
